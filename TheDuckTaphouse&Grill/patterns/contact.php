...
<p class="has-medium-font-size">Monday - Thursday: </p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>10 AM - Midnight Sunday: Closed</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></section>
<!-- /wp:group --></section>
<!-- /wp:group -->
...
<!-- wp:group {"tagName":"section","layout":{"type":"constrained"}} -->
<section class="wp-block-group"><!-- wp:paragraph {"fontSize":"large","fontFamily":"playfair-display"} -->
