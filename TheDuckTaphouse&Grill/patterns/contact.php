...
<img alt="" src="<?= get_stylesheet_directory_uri(); ?>/images/duck-opening.avif" style="object-fit:cover"/>
<!-- /wp:image -->
...
<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/ripped-paper.webp" alt="" class="paper flip-h flip-v">
...
<img alt="Several golden roasted chicken breasts." src="<?php echo get_stylesheet_directory_uri(); ?>/images/catering-poloroid-contact.avif"  style="object-fit:cover"/>
<!-- /wp:image -->
<?= do_shortcode('[wpforms id="375"]') ?>
