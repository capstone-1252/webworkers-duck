...
<figure class="wp-block-image"><img alt="Several golden roasted chicken breasts." src="<?php echo get_stylesheet_directory_uri(); ?>/images/catering-poloroid-contact.avif"  style="object-fit:cover"/></figure>
<!-- /wp:image -->
