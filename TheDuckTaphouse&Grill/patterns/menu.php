...
<!-- wp:media-text {"mediaPosition":"right","mediaId":299,"mediaLink":"http://ducktaphouseandgrill.local/?attachment_id=299","mediaType":"image"} -->
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile" id="breakfasts-section"><div class="wp-block-media-text__content breakfasts"><div class="menu-band-content-wrap">
...
<!-- /wp:paragraph --></div></div><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/breakfast.png" alt="" class="wp-image-299 size-full"/></figure></div>
<!-- /wp:media-text -->

<!-- wp:media-text {"mediaPosition":"right","mediaId":300,"mediaLink":"http://ducktaphouseandgrill.local/?attachment_id=300","mediaType":"image"} -->
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile appetizers" id="appetizers-section"><div class="wp-block-media-text__content"><div class="menu-band-content-wrap"><!-- wp:heading -->
...
<img src="/wp-content/themes/TheDuckTaphouse%26Grill/images/pin.png" alt="" class="pin">
<!-- /wp:html -->
...
<!-- wp:group {"className":"description","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group description"><!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"description","fieldSettings":{"type":"textarea","key":"field_69b834a04d243"},"hideEmpty":true,"prefix":"","displayLayout":"inline-block","tagName":"p"} /--></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p><a href="/#menu" data-type="internal" data-id="#menu">&lt;-- Back to Menu</a></p>
<!-- /wp:paragraph --></div></div><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/appetizers.png" alt="" class="wp-image-300 size-full"/></figure></div>
<!-- /wp:media-text -->

<!-- wp:media-text {"mediaId":301,"mediaLink":"http://ducktaphouseandgrill.local/?attachment_id=301","mediaType":"image"} -->
<div class="wp-block-media-text is-stacked-on-mobile soup-and-salads" id="soup&amp;salads-section"><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/soup-and-salad.png" alt="" class="wp-image-301 size-full"/></figure><div class="wp-block-media-text__content"><div class="menu-band-content-wrap">

<!-- wp:heading -->
<h2 class="wp-block-heading">Soup &amp; Salads</h2>
<!-- /wp:heading -->

<!-- wp:query {"queryId":6,"query":{"perPage":10,"pages":0,"offset":0,"postType":"menu-item","order":"asc","orderBy":"title","author":"","search":"","exclude":[],"sticky":"","inherit":false,"parents":[],"format":[],"taxQuery":{"menu-category":[12]}},"tagName":"section","layout":{"type":"default"}} -->
<section class="wp-block-query"><!-- wp:post-template {"style":{"spacing":{"blockGap":"0"}}} -->
<!-- wp:group {"tagName":"article","layout":{"type":"constrained"}} -->
<article class="wp-block-group"><!-- wp:group {"className":"menu-dotted-row","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group menu-dotted-row"><!-- wp:post-title {"level":3} /-->
...
<div class="wp-block-media-text is-stacked-on-mobile mains" id="mains-section"><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/mains.png" alt="" class="wp-image-302 size-full"/></figure><div class="wp-block-media-text__content"><div class="menu-band-content-wrap"><!-- wp:heading -->
...
<!-- wp:group {"className":"add-on","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
<div class="wp-block-group add-on"><!-- wp:mfb/meta-field-block {"fieldType":"acf","fieldName":"add-on_name_1","fieldSettings":{"type":"text","key":"field_69b6fff37aa66"},"hideEmpty":true,"prefix":"","displayLayout":"inline-block","tagName":"p","className":"no-wrap-1"} /-->
...
<!-- wp:media-text {"mediaPosition":"right","mediaId":303,"mediaLink":"http://ducktaphouseandgrill.local/?attachment_id=303","mediaType":"image"} -->
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile handhelds" id="handhelds-section"><div class="wp-block-media-text__content"><div class="menu-band-content-wrap">
...
<!-- wp:paragraph -->
<p><a href="/#menu" data-type="internal" data-id="#menu">&lt;-- Back to Menu</a></p>
<!-- /wp:paragraph --></div></div><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/handhelds.png" alt="" class="wp-image-303 size-full"/></figure></div>
<!-- /wp:media-text -->

<!-- wp:media-text {"mediaPosition":"right","mediaId":304,"mediaLink":"http://ducktaphouseandgrill.local/?attachment_id=304","mediaType":"image"} -->
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile pizzas" id="pizza-section"><div class="wp-block-media-text__content"><div class="menu-band-content-wrap"><!-- wp:group {"tagName":"section","layout":{"type":"constrained"}} -->
...
<!-- wp:paragraph -->
<p><a href="/#menu" data-type="internal" data-id="#menu">&lt;-- Back to Menu</a></p>
<!-- /wp:paragraph --></div><figure class="wp-block-media-text__media"><img src="http://ducktaphouseandgrill.local/wp-content/uploads/2026/03/pizza.png" alt="" class="wp-image-304 size-full"/></figure></div>
<!-- /wp:media-text --></main>
<!-- /wp:group -->
